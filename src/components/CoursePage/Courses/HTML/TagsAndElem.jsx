  ...
  return (
    <>
      ...
      <ul className="mgl-8 mgt-3">
        ...
        <li className="mgt-2 fw-5">They are written within angle brackets, like <InlineSyntaxHighlight code={"<tagname>"}/> </li>
        <li className="mgt-2 fw-5">Tags usually come in pairs: an opening tag <InlineSyntaxHighlight code={"<tagname>"}/> and a closing tag <InlineSyntaxHighlight code={"</tagname>"}/> but some tags are self-closing, like <InlineSyntaxHighlight code={"<img />"}/></li>
      </ul>
      ...
      <ul className="mgl-8 mgt-3">
        ...
        <li className="mgt-2 fw-5">Elements define the structure and content of the web page. For example, <InlineSyntaxHighlight code={"<p>This is a paragraph.</p>"} /> is a paragraph element.</li>
      </ul>

      <div className="inside-explaination">
        <h3 className='mgt-8 mgb-2'>Explanation:</h3>
        <ul className="mgl-8 mgt-3">
          <li className="mgt-2 fw-5"><InlineSyntaxHighlight code={"<p>"} /> is the opening tag.</li>
          <li className="mgt-2 fw-5"><InlineSyntaxHighlight code={"</p>"} /> is the closing tag.</li>
