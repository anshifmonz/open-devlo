...
function Syntax() {
  return (
    <>
      ...
      <CodePlayground code={{css: syntax.syntax.css, html: syntax.syntax.html}} langs={'CSS HTML'} />
      <p className='fw-5 mgb-1 lh-2 mgt-5'>This CSS rule selects all <InlineSyntaxHighlight lang={'html'} code={'<p>'} /> elements and changes their text color to blue and font size to 16px.</p>
    </>
  )
}
